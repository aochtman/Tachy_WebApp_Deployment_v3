...
# CALLBACKS
########################################################################################################################################################
db = DatabaseController('root','4854197saw','tachy','localhost') # Heroku DB
...
def populate_datatable(value):
    db = DatabaseController('root','4854197saw','tachy','localhost')
    # db = DatabaseController('b59b25a8f483fb','df9f008b','heroku_59f0bb8d5ef8c3d','us-mm-dca-c6a1e480c80b.g5.cleardb.net') # Heroku DB
    ...
    print('[populate_datatable] active_cell', active_cell)
    selected_cells = [
...
def highlight_row(active_cell):
    if active_cell is not None:
        print('active cell in highlight row', active_cell)
        return [{
